...
INSERT INTO `offensive` VALUES (1,1,'마커스 래쉬포드','맨체스터 유나이티드',5,2,3,1,2,4,7,'Y'),(2,1,'제임스 매디슨','레스터 시티',3,1,5,3,0,5,8,'N'),(3,9,'사디오 마네','리버풀',3,2,3,2,1,4,9,'Y'),(4,1,'매과이어','레스터 시티',1,0,2,1,0,1,7,'N');
